...
export function ConseilProfileTeam() {
    const [teamMembersConseil, setTeamMembersConseil] = useState([]);
    ...
    useEffect(() => {
        ...
        db.collection('staff')
            .where('isConseil', '==', true)
            .get()
            .then((querySnapshot) => {
                const data = querySnapshot.docs.map((doc) => doc.data());
                setTeamMembersConseil(data);
            })
            .catch((error) => {
    ...
    return (
        <div>
            <Typography variant="h3" color="blue-gray" className="mb-2">Le Conseil d'administration</Typography>
            <hr style={{paddingTop : "5px", paddingBottom : "5px"}}/>
            <div class="grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {teamMembersConseil.map((member) => (
                    <div key={member.id}>
                        <Card className="w-96">
                            <div>
